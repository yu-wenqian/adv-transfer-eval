import torch
from codes.model.snn_models.distributed_utils.dist_helper import allaverage, allreduce

from codes.model.snn_models.spiking_layer import SpikeModel, SpikeModule, lp_loss
...
def bias_corr_model(model: SpikeModel, train_loader: torch.utils.data.DataLoader, correct_mempot: bool = False,
    ...
    for (input, target, filename) in train_loader:
