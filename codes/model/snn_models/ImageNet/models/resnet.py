...
from codes.model.snn_models.spiking_layer import SpikeModule, Union
from codes.model.snn_models.utils import AvgPoolConv, StraightThrough
...
def resnet34_snn(pretrained=True, use_bn=True, **kwargs):
    ...
    if pretrained:
        if use_bn:
            load_model_pytorch(model, './codes/model/snn_models/SNNC_checkpoints/res34_snn.pth.tar')
        else:
            load_model_pytorch(model, './codes/model/snn_models/SNNC_checkpoints/res34_snn_wobn.pth.tar')
