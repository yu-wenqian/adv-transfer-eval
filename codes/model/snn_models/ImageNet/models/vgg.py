...
from codes.model.snn_models.spiking_layer import SpikeModule
...
model_urls = {
    'vgg16': './codes/model/snn_models/SNNC_checkpoints/vgg16_woBN_imagenet.pth.tar',
    'vgg16_bn': './codes/model/snn_models/SNNC_checkpoints/vgg16_snn.pth.tar',
}
