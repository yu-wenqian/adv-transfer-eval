...
from codes.model.snn_models.ImageNet.models.vgg import load_model_pytorch
...
def mobilenetv1(pretrained=False):
    ...
    if pretrained:
        load_model_pytorch(model, "./codes/model/snn_models/SNNC_checkpoints/mobilenetv1_imagenet.pth.tar")
    return model
